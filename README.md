...
<a href="./LICENSE">
    <img src="https://img.shields.io/github/license/yan-zero/nonebot-plugin-savepic.svg" alt="license">
</a>
<a href="https://pypi.python.org/pypi/nonebot-plugin-savepic">
    <img src="https://img.shields.io/pypi/v/nonebot-plugin-savepic.svg" alt="pypi">
</a>
...
3. 全局替换`yan-zero`为仓库所有者ID; 全局替换`nonebot-plugin-savepic`为插件名; 全局替换`nonebot_plugin_savepic`为包名; 修改 python 徽标中的版本为你插件的运行所需版本
